...
namespace Identity
{
    public static class ServiceExtensions
    {
        public static void AddIdentityInfraestructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.Configure<JWTSettings>(configuration.GetSection("JWT_AppSettings"));
            ...
            }).AddJwtBearer(o =>
            {
                ...
                o.TokenValidationParameters = new TokenValidationParameters()
                {
                    ...
                    ValidIssuer = configuration["JWT_AppSettings:Issuer"],
                    ValidAudience = configuration["JWT_AppSettings:Audience"],
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(configuration["JWT_AppSettings:Key"]))
                };
