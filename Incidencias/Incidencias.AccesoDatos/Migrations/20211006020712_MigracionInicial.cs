    ...
    public partial class MigracionInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, null, new DateTime(2021, 10, 5, 21, 7, 11, 945, DateTimeKind.Local).AddTicks(9478), "Facturacion" },
                    { 2, 1, null, new DateTime(2021, 10, 5, 21, 7, 11, 947, DateTimeKind.Local).AddTicks(679), "Financiero" },
                    { 3, 1, null, new DateTime(2021, 10, 5, 21, 7, 11, 947, DateTimeKind.Local).AddTicks(734), "Salud" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(446), 1, 1 },
                    { 9, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(2126), 3, 1 },
                    { 2, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(1947), 2, 2 },
                    { 4, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(2007), 1, 2 },
                    { 5, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(2030), 2, 2 },
                    { 6, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(2058), 2, 3 },
                    { 7, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(2080), 2, 4 },
                    { 10, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(2153), 3, 4 },
                    { 3, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(1983), 3, 5 },
                    { 8, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(2103), 2, 5 },
                    { 11, new DateTime(2021, 10, 5, 21, 7, 11, 948, DateTimeKind.Local).AddTicks(2177), 3, 5 }
                });
