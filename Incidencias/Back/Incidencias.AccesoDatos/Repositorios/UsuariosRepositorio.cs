...
namespace Incidencias.AccesoDatos.Repositorios
{
    public class UsuariosRepositorio : IUsuariosRepositorio
    {
        ...
        public UsuariosRepositorio(Contexto contexto, ILogger<UsuariosRepositorio> logger, IPasswordHasher<Usuario> passwordHasher)
        {
        ...
        public async Task<IEnumerable<Usuario>> ObtenerTodosAsync()
        {
            return await _dbSet
                .Include(usuario => usuario.Perfil)
                .Where(u => u.Estatus == EstatusUsuario.Activo).ToListAsync();
        }
