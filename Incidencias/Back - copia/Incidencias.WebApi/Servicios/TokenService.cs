...
namespace Incidencias.WebApi.Services
{
    public class TokenService
    {
        ...
        public string GenerarToken(Usuario usuario)
        {
            ...
            // Creamos el objeto JwtSecurityToken token de seguridad            
            ...
            // Creamos una representación en cadena del Token JWT (Json Web Token) que es 
            // el metodo que lo va autilizar
